...
CREATE TABLE `user` (
  ...
  `user_login_by` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `user` VALUES (1,'leo','sklyut','bananas',NULL,NULL);
...
CREATE TABLE `wall` (
  ...
  `wall_text` text,
  `wall_thumb` varchar(255) DEFAULT NULL,
...
INSERT INTO `wall` VALUES (1,1,'this is wall text',NULL,'2015-10-21 17:11:16',1,1,1);
...
-- Dump completed on 2015-10-21 17:13:05
